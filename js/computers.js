...
function refreshComputers() {
    ...
    for (var index = 0; index < computers.length; index++) {
        ...
        computersTableBodyElementHtml += ' AZN</td><td> <button class="btn btn-danger"' +
            ' onclick="onDevareComputer(' + computer.id + ')" >Удалить</button>  ' +
...
function onSaveComputer(event) {
    ...
    var computer = {};
    var computerId = 0;
    for (var index = 0; index < computersGlobal.length; index++) {
...
function onDevareComputer(computerId) {
...
function addComputersToPage(computersLocal) {
    ...
    for (var index = 0; index < computersLocal.length; index++) {
